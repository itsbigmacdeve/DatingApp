...
public class UsersControllers : BaseApiController
{
    ...
    public UsersControllers(IUnitOfWork uow , IMapper mapper, IPhotoService photoService)
    {
       _uow = uow;
       _mapper = mapper;
    ...
    public async Task<ActionResult<PagedList<MemberDto>>> GetUsers([FromQuery]UserParams userParams)
    {
        ...
        var gender = await _uow._userRepository.GetUserGender(User.GetUsername());
        ...
        var users = await _uow._userRepository.GetMembersAsync(userParams);
    ...
    public async Task<ActionResult<MemberDto>> GetUser(string username)
    {
        ...
        return await _uow._userRepository.GetMemberAsync(username);
    ...
    public async Task<ActionResult> UpdateUser(MemberUpdateDto memberUpdateDto)
    {
        ...
        var user = await _uow._userRepository.GetUserByUsernameAsync(User.GetUsername());
        ...
        //_uow._userRepository.Update(user);
